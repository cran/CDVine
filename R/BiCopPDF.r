BiCopPDF<-function(u1,u2,family,par,par2=0)
{
  ...
  coplik = function(u,v) .C("copLik_mod",as.integer(family),as.integer(1),as.double(u),as.double(v),as.double(par),as.double(par2),as.double(0),PACKAGE='CDVine')[[7]]

  res = mapply(coplik, u1, u2, SIMPLIFY=TRUE)
